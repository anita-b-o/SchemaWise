...
export const projectApi: ProjectApi = {
  ...
  async getProject(projectId) { return (await httpRequest<{ project: ProjectDto }, ProjectErrorCode | "UNAUTHENTICATED">(`/projects/${encodeURIComponent(projectId)}`, { credentials: "include" })).project; },
